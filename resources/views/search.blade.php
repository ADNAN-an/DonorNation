...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/search.css') }}" rel="stylesheet">
</head>
@section('content')
    <section>
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 rounded-3 shadow p-5 position-relative bg-white searchBox">
                    ...
                    <form id="donorsSearchForm" method="get" action="{{ url('search') }}"
            ...
            <div class="container shadow-lg donorCard d-flex flex-column">
              <div class="donorInfo px-3 py-3 row">
                  <div class="infos col-9">
                      <span class="text-danger fs-4"><strong class="text-dark">FULL NAME:</strong> Name</span>
                      <br>
                      <span class="text-danger fs-4"><strong class="text-dark">VILLE:</strong>VILLE Name</span>
                      <br>
                      <span class="text-danger fs-4"><strong class="text-dark">ADRESS MAIL:</strong>MAIL</span>
                      <br>
                      <span class="text-danger fs-4"><strong class="text-dark">PHONE NUMBER:</strong>PSSWD</span>
                  </div>
        ...
        <div class="searchResult container d-flex flex-wrap gap-4 justify-content-center">
            ...
            <div class="container shadow-lg donorCard d-flex flex-column">
                ...
                <div class="donorPhone bg-danger p-3 bg-light row">
                    ...
                    <strong
                        ...
                        style="user-select: all; color: black;">
            ...
            <div class="container shadow-lg donorCard d-flex flex-column">
                ...
                <div class="donorPhone bg-danger p-3 bg-light row">
                    <a class="col-4 d-lg-none" href="tel:0798257795"><button class="btn btn-success w-100"
                            type="button">
      ...
      <span class="page-link">« Précédent</span>
          ...
          <li class="page-item">
      <a class="page-link text-danger" href="https://linatabara3.com/fr/donors?page=2" rel="next">Suivant »</a>
      </li>
      </ul> -->
                </div>
    </section>
